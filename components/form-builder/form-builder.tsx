...
export function FormBuilder() {
  ...
  const [formDescription, setFormDescription] = useState("Build your form by adding fields")
  ...
  const addField = (fieldType) => {
    const newField = {
      ...
      required: false,
      options:
        fieldType === "select" || fieldType === "radio" || fieldType === "checkbox" ? ["Option 1", "Option 2"] : [],
      ...(fieldType === "image" && {
        label: "Image Upload",
        maxSize: 5,
    ...
    <div className="flex h-full bg-background">
      ...
      <div className="w-80 border-l border-border bg-card flex flex-col">
        <div className="p-4 border-b border-border flex items-center justify-between">
          ...
          <Button size="sm" variant="outline" onClick={() => setIsPreviewMode(true)} className="gap-2">
      ...
      {logicPanelFieldId && (
        <LogicPanel
          ...
          allFields={fields}
          onUpdate={(logic) => updateFieldLogic(logicPanelFieldId, logic)}
